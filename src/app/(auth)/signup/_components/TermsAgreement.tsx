  ...
  return (
    <div className="mt-4 space-y-2">
      ...
      <label className="flex items-center justify-between">
        <span>
          <input type="checkbox" {...registerAction("agree1")} className="mr-2" />
      ...
      <label className="flex items-center justify-between">
        <span>
          <input type="checkbox" {...registerAction("agree2")} className="mr-2" />
          [필수] 이용약관을 확인했으며, 동의합니다.
        </span>
        <span className="text-gray-400">▶</span>
      </label>
      <label className="flex items-center justify-between">
        <span>
          <input type="checkbox" {...registerAction("agreeMarketing")} className="mr-2" />
          [선택] 마케팅 정보 수신에 동의합니다.
        </span>
        <span className="text-gray-400">▶</span>
      </label>
